...
currency = "other"; // [usd:USD - US dollar, eur:EUR - Euro, chf:CHF - Swiss franc, cad:CAD - Canadian dollar, thb:THB - Thai Baht, other:Other (See "Slot customization" tab above)]
...
coin_1_diameter = 23.88;
// in millimeters.
coin_1_thickness = 1.58;
// The second coin. Remember: this 2nd coin should always be smaller than the 1st coin.
coin_2_diameter = 21.20;
coin_2_thickness = 1.76;
// The 3rd coin.
coin_3_diameter = 18.03;
coin_3_thickness = 1.22;
// 4th coin.
coin_4_diameter = 0;
coin_4_thickness = 0;
